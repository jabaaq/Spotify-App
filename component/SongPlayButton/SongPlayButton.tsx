import { PlayButtonProps } from "@/service/serviceInterfaces";
import "./SongPlayButton.css";

export default function SongPlayButton({ playSong }: PlayButtonProps) {
  return (
    <label className="container">
      <input checked={playSong} type="checkbox" readOnly />
      <svg
        viewBox="0 0 384 512"
        height="1em"
